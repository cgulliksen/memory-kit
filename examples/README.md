...
If you build something interesting on top of this kit and want to share it as an example, open a PR with a `examples/{your-name}/` folder containing:

- A redacted copy of your `CLAUDE.md`
- A redacted copy of one `MASTER.md`
- One redacted `NN-*.md` showing the Resume highlights block in real use

Real examples beat tutorials.
